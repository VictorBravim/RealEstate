                                ...
                                <div className="light-slide-item">
                                    <div className="clearfix">
                                        <ul id="image-gallery" className="gallery list-unstyled cS-hidden">
                                            <li data-thumb="/img/casa4.webp">
                                                <img src="/img/casa5.webp" />
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div className="single-property-wrapper">
                                ...
                                <div className="section additional-details">
                                    ...
                                    <ul className="additional-details-list clearfix">
                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">Beira-mar</span>
                                            <span className="col-xs-6 col-sm-8 col-md-8 add-d-entry">Sim</span>
                                        </li>

                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">Construído</span>
                                            <span className="col-xs-6 col-sm-8 col-md-8 add-d-entry">2003</span>
                                        </li>
                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">Estacionamento</span>
                                        ...
                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">Vista</span>
                                            <span className="col-xs-6 col-sm-8 col-md-8 add-d-entry">Vista intracoastal</span>
                                        </li>

                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">Descrição da orla:</span>
                                ...
                                <div className="section property-video">
                                    <h4 className="s-property-title">Vídeo da propriedade</h4>
                                    <div className="video-thumb">
                                        <a className="video-popup" href="yout" title="Virtual Tour">
                                            <img src="/img/casa1.webp" className="img-responsive wp-post-image" alt="Exterior" />
                                        </a>
                                    </div>
                                </div>

                                <div className="section property-share">
                                    <h4 className="s-property-title">Compartilhe com seus amigos </h4>
                                    <div className="roperty-social">
                                        <ul>
                                            <li><a title="facebok" href="#"><img src="/img/facebook_grey.webp" /></a></li>
                                            <li><a title="tumblr" href="#"><img src="/img/tumblr_grey.webp" /></a></li>
                                            <li><a title="twitter" href="#"><img src="/img/twitter_grey.webp" /></a></li>
                                            <li><a title="linkedin" href="#"><img src="/img/linkedin_grey.webp" /></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="dealer-content">
                                    <div className="inner-wrapper">
                                        <div className="single-property-header">
                                            <h1 className="property-title">Ville Sainte Hélène</h1>
                                            <span className="property-price">R$825,000</span>
                                        </div>
                                        ...
                                        <div className="property-meta entry-meta clearfix ">
                                            ...
                                            <div className="col-xs-4 col-sm-4 col-md-4 p-b-15">
                                                ...
                                                <span className="property-info-entry">
                                                    ...
                                                    <span className="property-info-value">À venda</span>
                                                </span>
                                            </div>
                                            ...
                                            <div className="col-xs-4 col-sm-4 col-md-4 p-b-15">
                                                ...
                                                <span className="property-info-entry">
                                                    <span className="property-info-label">Área</span>
                                                    <span className="property-info-value">3500<b
                                                        className="property-info-unit">m²</b></span>
                                                </span>
                                            </div>
                                            ...
                                            <div className="col-xs-4 col-sm-4 col-md-4 p-b-15">
                                                ...
                                                <span className="property-info-entry">
                                                    <span className="property-info-label">Lavanderia</span>
                                        ...
                                        <div className="clear">
                                            <div className="col-xs-4 col-sm-4 dealer-face">
                                                <a href="">
                                                    <img src="/img/client-face1.webp" className="img-circle" />
                                                </a>
                                            </div>
